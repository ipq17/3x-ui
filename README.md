...
```
bash <(curl -Ls https://raw.githubusercontent.com/ipq17/3x-ui/master/install.sh)
```
...
```
bash <(curl -Ls https://raw.githubusercontent.com/ipq17/3x-ui/master/install.sh) v2.3.7
```
